...
namespace NStuff.WindowSystem.ManualTest.Terrain
{
    internal struct ShaderProgram
    {
        ...
        internal void Delete(GraphicsLibrary gl)
        {
            gl.DeleteProgram(program);
        }

        internal void Use(GraphicsLibrary gl)
        {
        ...
        internal void Uniform3f(GraphicsLibrary gl, int uniform, float f0, float f1, float f2)
        {
            gl.Uniform3f(uniform, f0, f1, f2);
        }
