...
namespace NStuff.WindowSystem
{
    ...
    public abstract class NativeWindowServerBase
    {
        ...
        protected internal abstract void CreateWindowData(Window window);
        ...
        protected internal abstract void CreateWindow(Window window);

        /// <summary>
        /// Destroys the native window corresponding to the supplied managed window.
        /// </summary>
        /// <param name="window">The window to destroy.</param>
        protected internal abstract void DestroyWindow(Window window);
        ...
        protected internal abstract void RecreateNativeWindow(Window window);

        /// <summary>
        /// Gets the windows currently alive.
        /// </summary>
        /// <returns>A list of managed windows.</returns>
        protected internal abstract ICollection<Window> GetWindows();

        /// <summary>
        /// Attempts to bring the window to the foreground and activates it.
        /// </summary>
        /// <param name="window">The window to activate.</param>
        protected internal abstract void ActivateWindow(Window window);
        ...
        protected internal abstract bool IsWindowVisible(Window window);
        ...
        protected internal abstract void SetWindowVisible(Window window, bool visible);
        ...
        protected internal abstract bool IsWindowFocused(Window window);
        ...
        protected internal abstract bool IsWindowTopMost(Window window);
        ...
        protected internal abstract void SetWindowTopMost(Window window, bool topMost);
        ...
        protected internal abstract (double top, double left, double bottom, double right) GetWindowBorderSize(Window window);
        ...
        protected internal abstract void SetWindowCursor(Window window);
        ...
        protected internal abstract WindowBorderStyle GetWindowBorderStyle(Window window);
        ...
        protected internal abstract (double x, double y) GetWindowLocation(Window window);
        ...
        protected internal abstract void SetWindowLocation(Window window, (double x, double y) location);
        ...
        protected internal abstract (double width, double height) GetWindowMaximumSize(Window window);
        ...
        protected internal abstract void SetWindowMaximumSize(Window window, (double width, double height) size);
        ...
        protected internal abstract (double width, double height) GetWindowMinimumSize(Window window);
        ...
        protected internal abstract void SetWindowMinimumSize(Window window, (double width, double height) size);
        ...
        protected internal abstract double GetWindowOpacity(Window window);
        ...
        protected internal abstract void SetWindowOpacity(Window window, double opacity);
        ...
        protected internal abstract (double width, double height) GetWindowSize(Window window);
        ...
        protected internal abstract void SetWindowSize(Window window, (double width, double height) size);
        ...
        protected internal abstract WindowSizeState GetWindowSizeState(Window window);
        ...
        protected internal abstract void SetWindowSizeState(Window window, WindowSizeState sizeState);
        ...
        protected internal abstract string GetWindowTitle(Window window);
        ...
        protected internal abstract void SetWindowTitle(Window window, string title);
        ...
        protected internal abstract void SetFreeLookMouseWindow(Window window, bool enable);
        ...
        protected internal abstract (double x, double y) ConvertFromScreen(Window window, (double x, double y) point);
        ...
        protected internal abstract (double x, double y) ConvertToScreen(Window window, (double x, double y) point);

        /// <summary>
        /// Requests the attention of the user if the window in not visible.
        /// </summary>
        /// <param name="window">The window to signal.</param>
        protected internal abstract void RequestWindowAttention(Window window);
        ...
        protected internal abstract void CreateCursor(Cursor cursor, CursorShape shape);
        ...
        protected internal abstract void CreateCursor(Cursor cursor, byte[] imageData, (int width, int height) size, (double x, double y) hotSpot);

        /// <summary>
        /// Destroys the native data of the supplied cursor.
        /// </summary>
        /// <param name="cursor">The cursor to destroy.</param>
        protected internal abstract void DestroyCursor(Cursor cursor);
        ...
        protected internal abstract (double x, double y) GetCursorPosition(Window window);
        ...
        protected internal abstract void SetCursorPosition(Window window, (double x, double y) position);
        ...
        protected internal abstract (double x, double y) GetWindowViewportSize(Window window);

        /// <summary>
        /// Gets the contents of the clipboard.
        /// </summary>
        /// <returns>A string representing the clipboard.</returns>
        protected internal abstract string GetClipboardString();

        /// <summary>
        /// Sets the contents of the clipboard.
        /// </summary>
        /// <param name="text">A string to send to the clipboard.</param>
        protected internal abstract void SetClipboardString(string text);

        /// <summary>
        /// Gets the set of pressed modifier keys.
        /// </summary>
        /// <returns>The flags representing the pressed modifier keys.</returns>
        protected internal abstract ModifierKeys GetModifierKeys();
        ...
        protected internal abstract string ConvertKeycodeToString(Keycode keycode);
        ...
        protected internal abstract double GetEventTime();
        ...
        protected internal abstract bool WaitAndProcessEvents();
        ...
        /// <returns><c>true</c> if at least one event was processed.</returns>
        protected internal abstract bool WaitAndProcessEvents(double timeout);

        /// <summary>
        /// Processes the queued events if any.
        /// </summary>
        /// <returns><c>true</c> if at least one event was processed.</returns>
        protected internal abstract bool ProcessEvents();
        ...
        /// </summary>
        protected internal abstract void UnblockProcessEvents();
